...
function inject(sb3) {
    ...
    function injectData(project) {
        ...
        for (let i = 0; i < charset.length; i++) {
            ...
            let svg = `<svg width="480px" height="360px" xmlns="http://www.w3.org/2000/svg"><rect x="216" y="124" width="80.5" height="80.5" fill-opacity="0"/><path fill="#F00" d="${path}"/></svg>`
            // Width and height of 80.5 instead of 80 to because otherwise SFE++ text quality is bad on my iPhone
    ...
    function addKerning(font, fontSize, newCKern) {
        ...
        let disableKerning = document.getElementById("disableKerning").checked;
        if (disableKerning) {
